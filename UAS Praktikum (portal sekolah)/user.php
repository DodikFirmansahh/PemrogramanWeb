                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card-header">
                            <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah 
                            User</span>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    class="form-control border: none; border-buttom: 1px;" 
                                ...
                                <div class="mb-3 row">
                                    ...
                                    col-form-label">:</label>
                                    <div class="col-sm-9" style="margin-left: -20px;">
                                    <input type="text" class="form-control border: none; border-buttom: 1px;" 
                                    id="nama" name="nama"
                                    maxlength="20" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <label for="" class="col-sm-1 
                                    col-form-label">:</label>
                                    <div class="col-sm-9" style="margin-left: -20px; margin-top: 5px;">
                                        <select name="jabatan" id="jabatan" class="">
                                            <option value="" selected>--Pilih Jabatan--</option>
                                            <option value="Kepala Prodi">Kepala Prodi</option>
                                            <option value="Staf TU">Staf TU</option>
                                            <option value="Dosen">Dosen Mata Kuliah</option>                                        
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -20px;">
                                        ...
                                        rows="3" class="form-control" placeholder="domisili" required></textarea>
                                    </div>
                                </div>
                                </div>
                                <div class="col-4 text-center px-5">
                                    <img src="assett/image/default.png" alt="gambar user"
                                    class="mb-3" width="40%">
                                    <input type="file" name="image" class="form-control form-control-sm"> 
                                    <small class="type-secondary">Pilih foto PNG, JPG atau JPEG dengan ukuran maximal 1 MB</small>
