...
<html>
<head>
    <title>Profile Sekolah - Universitas Paramadina</title>
    <link rel="stylesheet" href="../assett/sb_admin/css/styles.css">
</head>
<body>
    <?php
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 text-center px-5">
                                <input type="hidden" nama="gbrLama" value="<?= $data
                                ['gambar']?>">
                                <img src="../assett/image/<?= $data['gambar']?>" alt="gambar 
                                sekolah" class="mb-3" width="100%">
                                <input type="file" name="image" class="form-control
                                form-control-sm">
                                <small class="text-secondary">Pilih gambar PNG,JPG atau JPEG 
                                    dengan ukuran maximal 1 MB</small>
                            </div>
                            <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                name="email" value="<?= $data['email']?>" placeholder="email sekolah" required>
                                </div>
                                </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -30px;">
                                    <textarea name="visimisi" id="visimisi" cols="30" rows="3" class="form-control" required>
                                    <?= $data['visimisi']?>"</textarea>
                                </div>
                                </div>
                            </div>
                        </div>
